...
export const logs: Log[] = [
  { slug: "melbourne", place: "Melbourne", country: "Australia", when: "F1 weekend", note: "Albert Park. Porsche Cup on the support bill, F1 on Sunday, laneways in between.", photos: 2 },
